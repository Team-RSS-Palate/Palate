				...
				<div className="row">
					<div className="col-lg-6">
						<div style={{ marginTop: '40%', marginBottom: '60%' }}>
							...
							<div>
								<form>
									<div>
										<p style={tinyLabelStyles}>Name</p>
										<input placeholder="Jon Smith" style={inputStyles} type="text" />
									</div>
									...
									<div style={{ marginTop: '10%' }}>
										<span style={signupLabeltyles}>Have an account already?</span>
										<span style={signupLabeltylesRed}> Log in</span>
									</div>
								</form>
							</div>
						</div>
					...
					<div className="col-lg-6" style={{ background: 'rgba(253, 92, 99, 0.5)' }}>
						<div style={{ marginLeft: '100px', marginTop: '190px' }}>
							<h2 style={secondHeadingStyles}>Hello friends!</h2>
							<p style={{ fontSize: '18px', color: '#333', width: '229px', fontFamily: 'Roboto' }}>
								To keep you protected please fill in your personal info
							</p>
							<img
								src={burger}
								alt="burger"
